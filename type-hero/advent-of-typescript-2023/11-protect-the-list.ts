...
// [Wurnose] Yes.
// And now I've just gotten word from the higher-ups that I have to make our entire codebase's types readonly.
// DEEP readonly.

// [Alabaster] Ouch.
// But at least it'll be better because something something functional programming superiority something something..

// [Wurnose] That's not the point.
// The point is that there IS NO POINT.
// They're saying this is a requirement of SOC2.
// This doesn't have the slightest thing to do with SOC2.
// It's literally security theater at this point.
...
// [Wurnose] I already tried that.
// They said Rust is too new and untested.
// They're considering Go, though.

// [Alabaster] Lol dafuq?
// Rust is older than Go by like 3 years.
// Ok.
// Sorry I asked.
// Let's implement DeepReadonly then!
...
// Answer
type HasKeys<T> = T extends Record<PropertyKey, unknown> ? true : T extends Array<unknown> ? true : false;

type SantaListProtector<T> = {
  readonly [K in keyof T]: HasKeys<T[K]> extends true ? SantaListProtector<T[K]> : T[K];
};
