...
// 'rehsaD' should be transformed into 'Dasher', 'recnaD' should be transformed into 'Dancer', 'recnarP' should be transformed into 'Prancer'.. DO I NEED TO KEEP GOING?

// [floor manager] Well you might be surprised.
...
// [Santa] Look, this is just an MVP.
...
// Answer
type Reverse<S extends string, R extends string = ""> = S extends `${infer First}${infer Rest}`
