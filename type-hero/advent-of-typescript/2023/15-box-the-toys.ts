...
// [Bernard (to his staff)] LET'S GO ELVES!
// LET'S GO!
// KEEP BOXING TOYS!
...
// [Bernard] No, we didn't get to it.
// Julius called out sick.

// [Santa] Taking too many sick days shows a lack of commitment.
// We should get rid of Julius.
...
// [Santa] Aren't we doing continuous deployment now?
// You had this whole big thing at the last shareholder meeting about it?

// [Bernard] No.
// For the 100th time.
// We're doing continuous delivery, which is completely different and gives us control over when we deploy.

// [Santa] Well I need that BoxToys type.
// If you can't handle this project, Bernard, there are plenty of other elves who can.
...
// We need to support the number of boxes being a union.
// That means our resulting tuple can also be a union.
// Check out test_nutcracker in the tests to see how that works.
...
// Answer
type BoxToys<Toy extends string, Boxes extends number, ToyBox extends Toy[] = []> = Boxes extends ToyBox["length"]
  ? ToyBox
  : BoxToys<Toy, Boxes, [...ToyBox, Toy]>;
