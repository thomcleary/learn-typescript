...
// A sign that reads "we're all about passion, not just paychecks" hangs above the entrance to the factory floor.]
...
// There's one elf on the team, Frymagen, that constantly reminds the others how incredible his Vim skills are.
...
// Answer
type SantasList<Bad extends readonly unknown[], Good extends readonly unknown[]> = [...Bad, ...Good];
